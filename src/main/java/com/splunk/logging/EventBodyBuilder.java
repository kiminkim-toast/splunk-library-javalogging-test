...
/**
 *
 * Define the interface to allow users to define their own event body builder for HTTP event adapter:
 * Simply create a class implementing this interface, and add the full class name as a property (`eventBodyBuilder`) to the adapter.
 *
*/
public interface EventBodyBuilder {

    Object buildEventBody(
            HttpEventCollectorEventInfo eventInfo,
            Object formattedMessage
    );

    class Default implements EventBodyBuilder {
